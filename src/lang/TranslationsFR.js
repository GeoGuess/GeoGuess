export default {
  fr: {
      Home: {
          ...
          aboutDescriptions: {
              1: 'Geoguess 2 est un jeu gratuit sans publicité.  \
          ...
          limitationDescription: "Actuellement, j'ai fixé un quota par jour afin que le coût du jeu ne soit pas élevé.\
      ...
      DialogSummary: {
        summaryMsgSingle: 'Vous êtes à <strong>{distance}</strong> km ! Votre score est de <strong>{points}</strong> points!',
        summaryMsgMulti: '<strong>{playerName}</strong> marque <strong>{points}</strong> points ! (<strong>{distance}</strong> km)',
