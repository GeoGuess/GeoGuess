export default {
    es: {
        Home: {
            ...
            limitationDescription: "Actualmente establezco cuotas por día para que el costo de ejecutar este juego no sea demasiado alto. \
        ...
        StreetView: {
            nearby: {
                ...
                message: 'Desafortunadamente, no pudimos encontrar una posición aleatoria en la ubicación definida. Sin embargo, hemos encontrado uno cerca 😉',
            },
            waitForOtherPlayers: 'Esperando a otros jugadores ...',
            redirectToHomePage: 'Redirigir a la página de inicio ...',
            exitGame: 'Estás obligado a salir del juego. Redirigir a la página de inicio después de 5 segundos ...',
            waitForOtherPlayersToFinish: 'Esperando a que otros jugadores terminen el juego ...',
        },
        Maps: {
        ...
        DialogRoom: {
            ...
            inProgress: 'El primer jugador está creando la sala ahora mismo. Espere y vuelva a intentarlo.',
        ...
        DialogSummary: {
            summaryMsgSingle: '¡Estás a <strong>{distance}</strong> km away! ¡Tu puntuación es de <strong>{points}</strong> puntos!',
            summaryMsgMulti: '¡La puntuación de <strong>{playerName}</strong> es <strong>{points}</strong> ! (<strong>{distance}</strong> km de distancia)',
