  ...
  <div id="home-page">
    <v-card 
      ...
      <v-card-text class="white--text pt-0">
        <v-container>
          <span>
            For a better experience while using this app, I may require you to provide this app with certain personally identificable information, including but not limited to your email address. The informaton that I request will be retained on the server for this app. 
            This app does use third party services that may collect information to identify you.
            Link to privacy policy of third party service providers used by this app.
          </span>
